...
const pillars: Pillar[] = [
  ...
  },
  {
    ...
    body: "You’ll understand the why behind every product, ingredient, and step — so the confidence stays with you.",
    icon: I.spark,
  },
  {
    title: "Trauma-Aware",
    body: "Care that’s as gentle with your story as it is with your skin barrier. You are safe here.",
    icon: I.shield,
  },
  {
    title: "Rooted in Compassion",
    body: "Real-life expertise from a woman who has lived it — and genuinely cares how you feel in your skin.",
    icon: I.leaf,
  },
];
...
export default function Service() {
  return (
    <section id="service" className="relative bg-sand py-28 sm:py-36">
      <div className="mx-auto max-w-7xl px-6">
        <div className="max-w-3xl">
          ...
          <Reveal delay={0.08}>
            <p className="mt-6 text-pretty text-[1.05rem] leading-relaxed text-espresso/80">
              ...
              thoughtful skincare questionnaires she’s designed just for you.
            </p>
          </Reveal>
        </div>
          ...
          {pillars.map((p, i) => (
            <Reveal key={p.title} delay={i * 0.08}>
              <TiltCard className="h-full">
                <div className="flex h-full flex-col rounded-3xl bg-cream p-7 ring-1 ring-plum/10 transition-shadow duration-300 hover:shadow-[0_30px_60px_-30px_rgba(94,58,73,0.45)]">
                  <span className="flex h-12 w-12 items-center justify-center rounded-full bg-blush/40 text-plum">
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="currentColor"
        ...
        <Reveal delay={0.1}>
          <p className="mx-auto mt-16 max-w-3xl text-balance text-center font-display text-2xl leading-snug text-plum sm:text-3xl">
            No overwhelm. No guesswork. Just the right products for your skin —
            and a woman who genuinely cares.
          </p>
        </Reveal>
      </div>
    </section>
