...
const steps = [
  ...
  },
  {
    ...
    body: "She personally researches and hand-picks the products and ingredients matched to you — safe, effective, and kind to your skin barrier.",
  },
  {
    n: "03",
      ...
      <div className="mx-auto max-w-3xl px-6">
        ...
        <div ref={ref} className="relative">
          ...
          <motion.div
            ...
            className="absolute bottom-2 left-[21px] top-2 w-px origin-top bg-gold"
          />

          <div className="space-y-12">
            {steps.map((s) => (
              <Reveal key={s.n}>
                <div className="relative grid grid-cols-[44px_1fr] gap-5">
                  <div className="z-10 flex h-11 w-11 items-center justify-center rounded-full bg-cream font-display text-plum ring-1 ring-plum/15">
                    {s.n}
                  </div>
